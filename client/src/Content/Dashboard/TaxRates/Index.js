...
import { Select, Card, DataTable, Page, Icon, Button, ButtonGroup, Link, TextContainer, Modal, TextField, FormLayout } from '@shopify/polaris';
...
const List = () => {
  ...
  const product_types = [
    ...
    { name: "Vape Mod Devices and Starter Kits", tag: "PACT-device" },
    { name: "Vape device parts/accessories such as Tanks, Empty Pods, Coils, Glasses, etc.", tag: "PACT-accessory" },
